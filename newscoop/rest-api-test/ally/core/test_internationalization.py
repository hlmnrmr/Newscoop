...
class TestInternationalization(unittest.TestCase):
    ...
    def testSuccesMessage(self):
        self.assertTrue(_('Hello world').default == 'Hello world')
        self.assertTrue(_('Hello $1', 'Gabriel').default == 'Hello Gabriel')
        self.assertTrue(_('Hello $2 from $1', 'europe', 'Gabriel').default == 'Hello Gabriel from europe')
        self.assertTrue(_('Hello $1 from $2 you have $3 euro', 'Gabriel', 'europe', 1000).default\
