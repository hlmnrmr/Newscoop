...
from newscoop.core.api.operator import Call, Service, Criteria, Query, Model, \
    Property, CriteriaEntry, Properties
from newscoop.core.api.type import TypeProperty, typeFor, TypeModel, List, Type, \
    TypeQuery
from newscoop.core.util import fullyQName, guard
import logging
