...
from newscoop.core.api.type import TypeProperty, TypeModel, TypeId, List, \
    TypeQuery
from newscoop.core.impl.node import NodeModel, NodeTypePropertyId
from newscoop.core.spec.resources import Assembler, Node, Invoker
import logging
import sys
