...
from newscoop.core.api.configure import APIModel as model, APIService as service, APIQuery as query, \
    APICall as call
from newscoop.core.api.type import List, Id
from newscoop.core.api.criteria import AsPaged
